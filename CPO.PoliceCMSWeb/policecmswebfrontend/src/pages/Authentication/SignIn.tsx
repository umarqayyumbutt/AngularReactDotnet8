...
const SignIn: React.FC = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      //console.log( response.data.token.result);
       const token  = response.data.token.result;
       const user = response.data.user.cmsUser;
       //console.log(response.data.user);
       const roles=response.data.user.roles;
       //console.log( response.data.token.result);
      // const token=response.data.result;
      // const user=response.data.cmsUser;
      console.log(roles);
      console.log(token);
      console.log(user);
      const loginTime = new Date().getTime(); // Get current timestamp
      dispatch(login({token,user,roles,loginTime}));
